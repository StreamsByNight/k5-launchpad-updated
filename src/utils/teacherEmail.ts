export const TEACHER_EMAIL_DOMAIN = 'stridek12learning.org';
 ...
 */
export function emailFromDisplayName(displayName: string): string {
  ...
  return `${firstInitial.toLowerCase()}${lastClean}@${TEACHER_EMAIL_DOMAIN}`;
}
